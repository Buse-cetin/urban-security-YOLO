var options = {
	...
	{
		name: "Other",
		data: [5, 25, 19, 10, 15, 23, 35, 22, 23, 15, 18, 29]
	}
	],
	chart: {
		height: 300,
...
var options4 = {
	...
	colors: ['#a4eb4e', '#f6a2d7', '#fffb8d', '#998def', '#b5497c'],
	...
	labels: ['Home Security', 'Shop Security', 'Construction Site Security', 'Factory Security','Other'],
};

var options5 = {
	series: [30, 30, 30, 30, 15],
	chart: {
		type: 'donut',
	},
	responsive: [{
...
var chart5 = new ApexCharts(document.querySelector("#mix-chart"), options5);
chart5.render();
// datatable init
